...
def test_statusline_starts_with_product_discovery(tmp_path):
    ...
    assert line == "BuildGuild Q1 [0/7] Product discovery -> /quest-status"
...
def test_statusline_points_to_ari_spec_after_product_discovery(tmp_path):
    ...
    assert line == "BuildGuild Q1 [2/7] Tour + spec -> ari-data-guide"
...
def test_statusline_points_to_maya_review_after_report(tmp_path):
    ...
    assert line == "BuildGuild Q1 [6/7] Maya review -> maya-tests-outputs"
...
def test_statusline_marks_complete_after_maya_review(tmp_path):
    ...
    assert line == "BuildGuild Q1 [7/7] Complete -> Quest 2 ready"
